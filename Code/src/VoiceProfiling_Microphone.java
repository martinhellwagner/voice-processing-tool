...
public class VoiceProfiling_Microphone extends JFrame implements PitchDetectionHandler {
    ...
    public static void main(String[] args) {
    	...
    	JFrame frame = new VoiceProfiling_Microphone();
		frame.pack();
        frame.setSize(653, 465);
        frame.setResizable(true);
		frame.setVisible(true);
     
    }
    
	public VoiceProfiling_Microphone() {
		...
		JLabel labelText = new JLabel("2. Press the start button and read the following text. When you're done, press the stop button.");
		JLabel labelProfile = new JLabel("3. Press the button to create your personal voice profile.");
        JLabel labelStatus = new JLabel();
		
		// initialize text fields
        JTextField fieldName = new JTextField();        
        JTextArea fieldText = new JTextArea("The quick brown fox jumps over the lazy dog. This is a test sentence to determine the musical scale my voice is operating in. " + 
        									"To do a thorough analysis, we need another test sentence though, which goes something like this: the quick brown fox again jumps over the lazy dog. " + 
        									"That should be enough. The musical scale of my voice will now be analyzed.");
        ...
        // add text field to second part of GUI
		fieldText.setLocation(169, 195);
		fieldText.setSize(452, 82);
        ...
        labelStatus.setLocation(205, 379);
