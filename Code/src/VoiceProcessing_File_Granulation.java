...
public class VoiceProcessing_File_Granulation extends JFrame implements PitchDetectionHandler {
    ...
    public static void main(String[] args) {
    	...
    	JFrame frame = new VoiceProcessing_File_Granulation();
		frame.pack();
	...
	public VoiceProcessing_File_Granulation() {
