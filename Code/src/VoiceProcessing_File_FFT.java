...
public class VoiceProcessing_File_FFT extends JFrame implements PitchDetectionHandler {
    ...
    public static void main(String[] args) {
    	...
    	JFrame frame = new VoiceProcessing_File_FFT();
		frame.pack();
	...
	public VoiceProcessing_File_FFT() {
    ...
    private void startIO() throws Exception {
        ...
        AudioFormat format = new AudioFormat((float) sampleRate, 16, 1, true, false);
     	...
     	// initialize components
		dispatcher = AudioDispatcherFactory.fromFile(new File("Unedited.wav"), bufferSize, bufferSize-256);
